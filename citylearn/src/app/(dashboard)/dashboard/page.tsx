...
export default function Page() {
  ...
  useEffect(() => {
    const runScript = () => {
      try {
        // Neural Dot Randomizer (no mouse movement triggers)
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white border border-border p-6 rounded-2xl border-l-4 border-l-primary shadow-sm hover:shadow transition-all">
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="text-[10px] font-bold text-purple-700 bg-purple-50 border border-purple-100 px-2 py-0.5 rounded">+12% vs last hour</span>
            </div>
            <h3 className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider font-sans mb-1">Events Learned</h3>
            <p className="font-display text-2xl font-bold text-foreground">1,482,903</p>
          </div>
          ...
          <div className="bg-white border border-border p-6 rounded-2xl border-l-4 border-l-secondary shadow-sm hover:shadow transition-all">
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="text-[10px] font-bold text-blue-700 bg-blue-50 border border-blue-100 px-2 py-0.5 rounded">Precision 99.4%</span>
            </div>
            <h3 className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider font-sans mb-1">Predictions Generated</h3>
            <p className="font-display text-2xl font-bold text-foreground">84,201</p>
          </div>
          ...
          <div className="bg-white border border-border p-6 rounded-2xl border-l-4 border-l-accent shadow-sm hover:shadow transition-all">
            ...
            <h3 className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider font-sans mb-1">Mistakes Prevented</h3>
            <p className="font-display text-2xl font-bold text-foreground">3,129</p>
          </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <div className="bg-white border border-border p-5 rounded-2xl flex flex-col justify-between h-32 shadow-sm">
              <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider block">Active Events</span>
            ...
            <div className="bg-white border border-border p-5 rounded-2xl flex flex-col justify-between h-32 border-l-4 border-l-destructive shadow-sm">
              <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider block">Critical Alerts</span>
              <div className="flex items-end justify-between">
                <span className="font-display text-2xl font-bold text-destructive">3</span>
            ...
            <div className="bg-white border border-border p-5 rounded-2xl flex flex-col justify-between h-32 shadow-sm">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-baseline">
                  <span className="font-display text-2xl font-bold text-foreground">74%</span>
                  <span className="text-accent text-[10px] font-bold uppercase tracking-wider">Elevated</span>
                </div>
                <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                  <div className="bg-gradient-to-r from-primary to-accent h-full rounded-full" style={{ width: "74%" }}></div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-border p-5 rounded-2xl flex flex-col justify-between h-32 shadow-sm">
              ...
              <div className="flex items-end justify-between">
                <span className="font-display text-2xl font-bold text-foreground">22<span className="text-sm font-sans font-normal text-muted-foreground">m</span></span>
          ...
          {/* Interactive Map Section - Fixed & Static */}
          <div className="md:col-span-6 bg-white border border-border rounded-2xl relative overflow-hidden min-h-[400px] shadow-sm">
            <div className="absolute top-4 left-4 z-10 flex flex-col gap-2">
              <div className="bg-white/90 backdrop-blur-md px-3 py-1.5 rounded-full flex items-center gap-2 border border-border shadow-sm">
                ...
                <span className="text-[9px] font-bold text-foreground tracking-wider uppercase font-sans">Downtown Hub</span>
              </div>
            </div>
            ...
            <div className="absolute bottom-4 right-4 z-10">
              <div className="bg-white/95 backdrop-blur-md p-3 rounded-xl border border-border space-y-1.5 shadow-md">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] font-bold text-muted-foreground uppercase tracking-wider font-sans">Traffic Closure</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-2.5 h-2.5 bg-primary rounded-full"></div>
                  <span className="text-[9px] font-bold text-muted-foreground uppercase tracking-wider font-sans">Live Sensor</span>
                </div>
              </div>
            </div>
          ...
          <div className="md:col-span-3 bg-white border border-border rounded-2xl p-6 flex flex-col shadow-sm">
            ...
            <div className="flex-grow space-y-6 overflow-y-auto pr-1">
              ...
              <div className="relative pl-6 border-l border-border pb-2">
                ...
                <span className="text-[9px] font-bold text-primary uppercase tracking-wider block font-mono">14:22 — Concert</span>
                <p className="text-xs text-foreground mt-0.5">Madison Sq. Arena inflow starting. Prediction: +20% congestion.</p>
              </div>

              {/* Feed Item 2 */}
              <div className="relative pl-6 border-l border-border pb-2">
                <div className="absolute -left-1.5 top-1.5 w-3.5 h-3.5 rounded-full bg-secondary border-2 border-white"></div>
                <span className="text-[9px] font-bold text-secondary uppercase tracking-wider block font-mono">13:45 — Sports</span>
                <p className="text-xs text-foreground mt-0.5">Match ended. Dispersal patterns detected in Sector 4.</p>
              </div>

              {/* Feed Item 3 */}
              <div className="relative pl-6 border-l border-border pb-2">
                <div className="absolute -left-1.5 top-1.5 w-3.5 h-3.5 rounded-full bg-destructive border-2 border-white"></div>
                <span className="text-[9px] font-bold text-destructive uppercase tracking-wider block font-mono">12:10 — Accident</span>
                <p className="text-xs text-foreground mt-0.5">Gridlock detected at Cross St &amp; 5th. Rerouting active.</p>
              </div>

              {/* Feed Item 4 */}
              <div className="relative pl-6 border-l border-border pb-2">
                <div className="absolute -left-1.5 top-1.5 w-3.5 h-3.5 rounded-full bg-accent border-2 border-white"></div>
                <span className="text-[9px] font-bold text-amber-700 uppercase tracking-wider block font-mono">11:05 — Recovery</span>
                <p className="text-xs text-foreground mt-0.5">Neural loop updated: Weather impact speed factor reduced by 5%.</p>
              </div>

            </div>
            <button 
              onClick={() => alert("Audit Full Stream: recent operational logs exported successfully.")}
              className="mt-4 w-full py-2.5 rounded-lg border border-border text-[9px] font-bold hover:bg-slate-50 transition-colors uppercase tracking-wider"
            >
              Audit Full Stream
            </button>
          </div>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white border border-border p-6 rounded-2xl shadow-sm">
            ...
            <div className="h-44 flex items-end gap-1.5 px-2">
              <div className="flex-1 bg-slate-100 rounded-t h-[40%] hover:bg-primary/20 transition-all cursor-pointer"></div>
              <div className="flex-1 bg-slate-100 rounded-t h-[60%] hover:bg-primary/20 transition-all cursor-pointer"></div>
              <div className="flex-1 bg-slate-100 rounded-t h-[35%] hover:bg-primary/20 transition-all cursor-pointer"></div>
              <div className="flex-1 bg-slate-100 rounded-t h-[85%] hover:bg-primary/20 transition-all cursor-pointer"></div>
              <div className="flex-1 bg-primary rounded-t h-[95%] shadow-sm"></div>
              <div className="flex-1 bg-slate-100 rounded-t h-[75%] hover:bg-primary/20 transition-all cursor-pointer"></div>
              <div className="flex-1 bg-slate-100 rounded-t h-[55%] hover:bg-primary/20 transition-all cursor-pointer"></div>
              <div className="flex-1 bg-slate-100 rounded-t h-[45%] hover:bg-primary/20 transition-all cursor-pointer"></div>
              <div className="flex-1 bg-slate-100 rounded-t h-[30%] hover:bg-primary/20 transition-all cursor-pointer"></div>
              <div className="flex-1 bg-slate-100 rounded-t h-[20%] hover:bg-primary/20 transition-all cursor-pointer"></div>
              <div className="flex-1 bg-slate-100 rounded-t h-[15%] hover:bg-primary/20 transition-all cursor-pointer"></div>
              <div className="flex-1 bg-slate-100 rounded-t h-[10%] hover:bg-primary/20 transition-all cursor-pointer"></div>
            </div>

            <div className="mt-4 pt-4 border-t border-border flex items-center justify-between">
              <div className="space-y-0.5">
                <span className="text-[9px] font-bold text-muted-foreground uppercase tracking-wider block font-sans">Peak Hour</span>
                <span className="text-xs font-semibold text-foreground">17:45 - High Density Corridor</span>
              </div>
              <button 
                onClick={() => alert("Adjust Sensors: local smart infrastructure signal timings updated successfully.")}
                className="bg-primary hover:bg-primary/95 text-white px-4 py-2 rounded-xl text-xs font-semibold shadow-sm hover:shadow active:scale-[0.98] transition-all"
              >
                Adjust Sensors
              </button>
            </div>
